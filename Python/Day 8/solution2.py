...
def solve(point_array: List[Point], uf: UnionFind):
    ...
    while True:
        ...
        if uf.all_connected():
            #print(shortest_points[0].x, shortest_points[1].x)
            return shortest_points[0].x  * shortest_points[1].x
